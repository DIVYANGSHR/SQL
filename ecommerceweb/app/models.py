...
class Watch(models.Model):
    ...
    Watch_image =models.ImageField(upload_to='Watch_images')  # As we are using image field we have to intall 'pillow'. And we have to Define MEDIA_URL in settings.py file so that all folder should save in media directory
