...
class DogCategoriesView(View):
    def get(self,request):
        dog_category = Watch.objects.filter(category='DOG')  # we are using filter function of queryset, that will filter those data whose category belongs to dog
...
class CatCategoriesView(View):
    def get(self,request):
        cat_category = Watch.objects.filter(category='CAT')  # we are using filter function of queryset, that will filter those data whose category belongs to dog
...
class watchDetailView(View):
    def get(self,request,id):     # id = It will fetch id of particular watch 
        ...
        return render(request,'core/watch_details.html',{'watch':watch,'percentage':percentage})
...
def buynow(request,id):
    ...
    return render(request, 'core/buynow.html', {'final_price':final_price,'address':address,'watch':watch})
...
def buynow_payment(request,id):
    ...
    return render(request, 'core/payment.html', {'final_price':final_price,'address':address,'watch':watch,'paypal':paypal_payment})
